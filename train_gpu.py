...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'VOLO training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=16, type=int)
    parser.add_argument('--epochs', default=5, type=int)
    parser.add_argument('--predict', default=True, type=bool, help='plot ROC curve and confusion matrix')

    # Model parameters
    parser.add_argument('--model', default='volo_d3', type=str, metavar='MODEL',
                        choices=['volo_d1', 'volo_d2', 'volo_d3', 'volo_d4', 'volo_d5'],
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'VOLO training and evaluation script', parents=[get_args_parser()])
