...
class VOLO(nn.Module):
    ...
    def __init__(self, layers, img_size=224, in_chans=3, num_classes=1000, patch_size=8,
                 ...
                 pooling_scale=2, out_kernel=3, out_stride=2, out_padding=1, **kwargs):
...
@register_model
def volo_d1(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    """
...
@register_model
def volo_d2(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    """
...
@register_model
def volo_d3(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    """
...
@register_model
def volo_d4(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    """
...
@register_model
def volo_d5(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    """
...
#     net = volo_d1(num_classes=5)
#     input_size = torch.randn(1, 3, 224, 224)
#     # summary(net, input_size=(1, 3, 224, 224))
#     # output = net(input_size) # tuple
#     # print(output[0].size()) # [1, 5]
#     # print(output[1].size()) # [1, 196, 5]
#     # print(len(output[2])) # 4
#
#     net.eval()
#     output = net(input_size)
#     print(output.size()) # [1, 5]