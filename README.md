...
The code mainly comes from [official source code](https://github.com/sail-sg/volo).  

## Preparation
### Download the dataset: 
[flower_dataset](https://www.kaggle.com/datasets/alxmamaev/flowers-recognition).
### Download the pretrained_weights
[pretrained_weights](https://github.com/sail-sg/volo/tree/main?tab=readme-ov-file#2-volo-models)
